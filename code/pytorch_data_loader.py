...
class PytorchLoader(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if 'adience' in self.ds.name.lower():
            ...
            protected_class = int(self.ds.get_image_protected_class(self.portion, index))
        elif self.ds.name.lower() == "cifar10":
            # Assign a dummy protected class: e.g., even classes = 0, odd classes = 1
            protected_class = class_label % 2
        else:
            protected_class = -1  # For unknown datasets
